...
██ ███ ██ ██  ███    ██ ███ ██ ██  ███         ██ ██  ██    ██ ██ 
 ███ ███  ██ ███████  ███ ███  ██ ███████     ██   ██  ██████  ██ 
\033[0m"
echo -e "    \e[31mTelegram Channel: \e[34m@wizwizch\033[0m | \e[31mTelegram Group: \e[34m@mramir-pc\033[0m\n"
...
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/v2bot/settings/messagewizwiz.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/v2bot/settings/rewardReport.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/v2bot/settings/warnusers.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/v2bot/settings/gift2all.php >/dev/null 2>&1") | sort - | uniq - | crontab -
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'wizwiz'") ]]; then
        ...
        file_path="/var/www/html/v2bot/baseInfo.php"
        ...
        # print file
        echo -e "<?php" >> /var/www/html/v2bot/baseInfo.php
        echo -e "error_reporting(0);" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}botToken = '${YOUR_BOT_TOKEN}';" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}dbUserName = '${dbuser}';" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}dbPassword = '${dbpass}';" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}dbName = '${dbname}';" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}botUrl = 'https://${YOUR_DOMAIN}/v2bot/';" >> /var/www/html/v2bot/baseInfo.php
        echo -e "${ASAS}admin = ${YOUR_CHAT_ID};" >> /var/www/html/v2bot/baseInfo.php
        echo -e "?>" >> /var/www/html/v2bot/baseInfo.php

        sleep 1

        curl -F "url=https://${YOUR_DOMAIN}/v2bot/bot.php" "https://api.telegram.org/bot${YOUR_BOT_TOKEN}/setWebhook"
        ...
        url="https://${YOUR_DOMAIN}/v2bot/createDB.php"
        curl $url
	    ...
	    sudo rm /var/www/html/v2bot/createDB.php
