...
$mainValues = [
    ...
    'increase_wallet_cart_to_cart'=>"💢 عزیزم یه تصویر از فیش واریزی برام ارسال کن :
    ...
    'please_send_only_image'=>"لطفا فقط عکس رسید را ارسال کنید",
    'reached_main_menu'=>"خب برگشتم عقب اگه کاری داری بگو 🫡👇",
...
",
    ...
    'buy_account_cart_to_cart'=>"💢 عزیزم یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن :

    💳 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME
    
    ✅ بعد از اینکه پرداختت تایید شد کانفیگ به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"💢 عزیزم یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن :
...
🔮 نام سرویس: REMARK
💮 سفارش: FILENAME",
    'renew_order_sent'=>"✅| دوست عزیز ، درخواستت با موفقیت ثبت شد، بعد از بررسی و تمدید ادمین کانفیگ رو برات میفرستم ممنون از صبوریت ❤️",
...
",
    ...
    'start_message'=>'سلاام به ربات خوش اومدی 🖖🌹

اینجا میتونی فیلترشکن بخری و به اینترنت آزاد دسترسی داشته باشی 😍😎
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'buy_sub_select_location' => '2️⃣ مرحله دو :
...
🔽 یکی از پلن ها رو انتخاب کنید و سپس فاکتور خود را پرداخت کنید :", 
...
$buttonValues = [
    ...
    'invite_friends'=>"دعوت و پورسانت 💰",
    'my_info'=>"📊 حساب کاربری",
    'my_subscriptions'=>'لیست سرویس ها 📃',
    'buy_subscriptions'=>'🛒 خرید سرویس',
    'shared_existence'=>"❕ موجودی اشتراکی ",
    'individual_existence'=>"❗️ موجودی اختصاصی ",
    'application_links'=>' 🔗 لینک برنامه ها',
    'my_tickets'=>"پشتیبانی و تیکت 📨",
